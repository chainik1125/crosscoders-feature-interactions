...
class SaveableModule(nn.Module, ABC):
    ...
    @classmethod
    @abstractmethod
    def _from_cfg(cls: type[Any], cfg: dict[str, Any]) -> Any: ...
    ...
    @classmethod
    def load(cls: type[Any], basepath: Path | str, device: torch.device | str = "cpu") -> Any:
...
def calculate_explained_variance_X(
    ...
    # mean_error_var_X = error_BXD.var(0).mean(-1)
    # mean_activations_var_X = activations_BXD.var(0).mean(-1)
